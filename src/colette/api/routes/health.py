"""Health, readiness, and version endpoints (NFR-REL-008)."""
...
from colette.api.schemas import HealthCheck, HealthResponse, VersionResponse
...
async def version_info() -> dict[str, Any]:
    """Full build and runtime metadata."""
